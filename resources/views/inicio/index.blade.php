...
<body>
    ...
    <section id="home">
        <div class="container">
            ...
            <a href="../shop" type="button" class="bn">Comprar ahora</a>
        </div>
    </section>
        ...
        <div class="row p-0 m-0">
            <div class="one col-lg-4 col-md-12 col-12 p-0">
                ...
                <div class="details">
                    ...
                    <a href="../shop" type="button" class="bn2">Comprar ahora</a>
                </div>
            </div>
    ...
    <section id="featured" class="my-5 pb-5">
        ...
        <div class="row mx-auto container-fluid">
            <div class="product text-center col-lg-3 col-md-4 col-12">
                <img class="img-fluid mb-3" src="/img/HP.jpg" alt="">
                <div class="star">
                ...
                <h5 class="p-name">PC HP</h5>
                <h4 class="p-price">$12,000.00</h4>
                <!--<button href="../shop" class="buy-btn">Comprar</button>-->
            </div>

            <div class="product text-center col-lg-3 col-md-4 col-12">
                <img class="img-fluid mb-3" src="/img/DELL.jpg" alt="">
                <div class="star">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-star-fill" viewBox="0 0 16 16">
                        <path
                ...
                <h5 class="p-name">PC DELL</h5>
                <h4 class="p-price">$200,000.00</h4>
                <!--<button href="../shop" class="buy-btn">Comprar</button>-->
            </div>

            <div class="product text-center col-lg-3 col-md-4 col-12">
                <img class="img-fluid mb-3" src="/img/MSI.jpg" alt="">
                <div class="star">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-star-fill" viewBox="0 0 16 16">
                        <path
                ...
                <h5 class="p-name">PC MSI</h5>
                <h4 class="p-price">$18,000.00</h4>
                <!--<button href="../shop" class="buy-btn">Comprar</button>-->
            </div>

            <div class="product text-center col-lg-3 col-md-4 col-12">
                <img class="img-fluid mb-3" src="/img/HUAWEI.jpg" alt="">
                <div class="star">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-star-fill" viewBox="0 0 16 16">
                        <path
                ...
                <h5 class="p-name">PC HUAWEI</h5>
                <h4 class="p-price">$39,453.00</h4>
                <!--<button href="../shop" class="buy-btn">Comprar</button>-->
            </div>
