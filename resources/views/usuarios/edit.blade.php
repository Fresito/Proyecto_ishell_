...
<body>
    ...
    <div class="container">
        ...
        <!--Formulario de usuarios-->        
                <form action="{{ route('modificar',['id'=>$usuario->id_usuario]) }}" method="POST" enctype="multipart/form-data" class="row g-3">
                    @csrf
                    @method ('PUT')
                            ...
                            <div class="form-group">
                              ...
                              <input type="date" class="form-control" name="fecha_nacimiento" value="{{ $usuario->fecha_nacimiento }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <input type="text" class="form-control" name="fotoB" value="{{ $usuario->foto }}">
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <input type="pass" class="form-control" name="pass" value="{{ $usuario->pass }}">
                            </div>
